  ...
  ...){
    ...
    if(n1_tot != 0 || n2_tot != 0){
      ...
      for(i in 1:max_iter){
        ...
        var <- var + hDP_var_help_int_tabs(int_cross_baseln,int_cross_custs,int_cross_tabs,int_cross_baseln_custs,int_cross_baseln_tabs,int_cross_tabs_custs,
    ...
    return(var/max_iter + c^2/(c+n_tot)^2*((valc0sq/max_iter - (valc0/max_iter)^2)*int_cross_baseln + 2*valc0l/max_iter - 2*valc0*vall/max_iter^2 + vallsq/max_iter - quad.form(outer_mat_dishes,vall_vec/max_iter)))
}